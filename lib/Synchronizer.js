...
const COUNT_PER_REQUEST_MIN = 32
const COUNT_PER_REQUEST_MAX = 64
        ...
        Asyncs.forEach(prevBlocks, ({branchId, afterHash}, i, nextBranch) => {
          const synchronizeBranch = () => {
            ...
            blockchain.whenUnlocked((unlockGlobal) => {
              net.requestBlocksAfter(afterHash, randomIntInc(COUNT_PER_REQUEST_MIN,COUNT_PER_REQUEST_MAX), (err, res) => {
                responses++
                if (err) {
